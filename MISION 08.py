...
# Esta función se encarga de ir sumando los números en la lista, es decir, acumulándolos
...
# Esta función se encarga de mencioanr si los números están ordenados o no
